...
ZoomPic.prototype = 
{
	initialize : function (id)
	{
		...
		for (var i = 0; i < this.aLi.length; i++) this.aSort[i] = this.aLi[i]; // 储存dom
	...
	doImgClick : function ()
	{
		...
		for (var i = 0; i < this.aSort.length; i++)
		{
			...
			{
				if (this.index > _this.iCenter)  //判断向左还是向右
				{	
	...
	setUp : function ()
	{
		...
		for (i = 0; i < this.aSort.length; i++)
		{
			...
			if (i < this.iCenter || i > this.iCenter) // 除了中间那一张之外，其他图片加hover效果
			{
